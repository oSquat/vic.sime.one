...
clean:
	...
	find . -path './env' -prune -o -path './.git' -prune -o -name '*.pyc' -exec rm {} \;
	find . -path './env' -prune -o -path './.git' -prune -o -name '*.swp' -exec rm {} \;
	find . -path './env' -prune -o -path './.git' -prune -o -type d -name '__pycache__' -prune -exec rm -r {} \;
